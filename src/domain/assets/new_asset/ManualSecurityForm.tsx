...
function ManualSecurityForm({
  onStockSubmitted,
}: {
  onStockSubmitted: () => void
}) {
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <input
            ...
            id="purchaseDate"
            className="block w-full rounded-md border-gray-300 text-gray-700 shadow-sm focus:border-primary focus:ring-primary dark:bg-gray-700 dark:text-white"
          />
        </div>
      </div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex-1">
          ...
          <input
            ...
            id="quantity"
            className="block w-full rounded-md border-gray-300 text-gray-700 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
          />
        </div>
...
export default ManualSecurityForm
